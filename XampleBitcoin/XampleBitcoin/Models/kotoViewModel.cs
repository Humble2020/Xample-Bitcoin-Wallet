...
{
    public class kotoViewModel : BaseViewModel
    {
        public kotoViewModel(INavigation Navigation, string Password, string walletPath)
        {
        ...
        public kotoViewModel Model { get; set; }
       ...
       public static bool CheckForInternetConnection()
        ...
        public async void Update()
        {
            ...
            foreach (var addr in data.addresses.change)
                if (!data.usedAddresses.Contains(addr))
                {
                    var address = BitcoinAddress.Create(addr, NBitcoin.Altcoins.Koto.Instance.Mainnet);
