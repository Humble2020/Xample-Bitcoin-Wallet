...
{
    public class argoneumViewModel : BaseViewModel
    {
        public argoneumViewModel(INavigation Navigation, string Password, string walletPath)
        {
        ...
        public argoneumViewModel Model { get; set; }
       ...
       public static bool CheckForInternetConnection()
        ...
        public async void Update()
        {
            ...
            foreach (var addr in data.addresses.change)
                if (!data.usedAddresses.Contains(addr))
                {
                    var address = BitcoinAddress.Create(addr, NBitcoin.Altcoins.Argoneum.Instance.Mainnet);
