...
{
    public class xdsViewModel : BaseViewModel
    {
        public xdsViewModel(INavigation Navigation, string Password, string walletPath)
        {
        ...
        public xdsViewModel Model { get; set; }
       ...
       public static bool CheckForInternetConnection()
        ...
        public async void Update()
        {
            ...
            foreach (var addr in data.addresses.change)
                if (!data.usedAddresses.Contains(addr))
                {
                    var address = BitcoinAddress.Create(addr, NBitcoin.Altcoins.XDS.Instance.Mainnet);
