...
{
    public class colossusViewModel : BaseViewModel
    {
        public colossusViewModel(INavigation Navigation, string Password, string walletPath)
        {
        ...
        public colossusViewModel Model { get; set; }
       ...
       public static bool CheckForInternetConnection()
        ...
        public async void Update()
        {
            ...
            foreach (var addr in data.addresses.change)
                if (!data.usedAddresses.Contains(addr))
                {
                    var address = BitcoinAddress.Create(addr, NBitcoin.Altcoins.Colossus.Instance.Mainnet);
