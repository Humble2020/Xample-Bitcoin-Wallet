...
{
    public class bitplusViewModel : BaseViewModel
    {
        public bitplusViewModel(INavigation Navigation, string Password, string walletPath)
        {
        ...
        public bitplusViewModel Model { get; set; }
       ...
       public static bool CheckForInternetConnection()
        ...
        public async void Update()
        {
            ...
            foreach (var addr in data.addresses.change)
                if (!data.usedAddresses.Contains(addr))
                {
                    var address = BitcoinAddress.Create(addr, NBitcoin.Altcoins.Bitcoinplus.Instance.Mainnet);
