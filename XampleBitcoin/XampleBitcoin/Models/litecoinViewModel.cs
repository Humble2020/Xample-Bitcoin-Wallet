...
{
    public class litecoinViewModel : BaseViewModel
    {
        public litecoinViewModel(INavigation Navigation, string Password, string walletPath)
        {
        ...
        public litecoinViewModel Model { get; set; }
       ...
       public static bool CheckForInternetConnection()
        ...
        public async void Update()
        {
            ...
            foreach (var addr in data.addresses.change)
                if (!data.usedAddresses.Contains(addr))
                {
                    var address = BitcoinAddress.Create(addr, NBitcoin.Altcoins.Litecoin.Instance.Mainnet);
