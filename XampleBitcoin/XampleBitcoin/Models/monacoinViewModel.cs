...
{
    public class monacoinViewModel : BaseViewModel
    {
        public monacoinViewModel(INavigation Navigation, string Password, string walletPath)
        {
        ...
        public monacoinViewModel Model { get; set; }
       ...
       public static bool CheckForInternetConnection()
        ...
        public async void Update()
        {
            ...
            foreach (var addr in data.addresses.change)
                if (!data.usedAddresses.Contains(addr))
                {
                    var address = BitcoinAddress.Create(addr, NBitcoin.Altcoins.Monacoin.Instance.Mainnet);
